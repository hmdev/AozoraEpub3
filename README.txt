...
Milestone1.0.7
　- タイトル前に画像がある場合に左右中央にならないバグを修正
　- 単ページ化と幅100%指定の画像サイズをと縦横比を設定
　- 単ページ化対象以外の横長画像で幅400以上は幅100%
　- 複数テキストを結合(仮) (ファイル名順、目次は各タイトル、Zip内1テキストのみ)
　- 表紙のプレビューでのトリミングとリサイズ
　- 表紙プレビューへのDnDでファイル入れ替え
　- 目次選択リスト (確認画面内)
　- 画像変換中のキャンセル
　- リサイズ前の画像を残して、リサイズ後は拡張子を.resized
