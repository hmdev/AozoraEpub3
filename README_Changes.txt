...
------------
[1.1.0]
1.0.7→1.1.0bでの主な変更点 (2012/12/31)
...
　- 目次抽出で表題の出力選択
　- タグの中で単ページ化しない場合にWARN
　- 表紙テンプレートでの中央寄せと横書き (template/OPS/xhtml/title_middle.vm , title_horizontal.vm)
　- kindle出力フラグが2回目以降の変換時に解除されていなかった
1.1.0b18 (2013/01/11)
