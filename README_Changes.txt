...
------------
[1.1.0]
1.0.7→1.1.0bでの主な変更点 (2012/12/20)
　- ルビ処理調整 (開始位置判別 注記をや画像を間に含むルビ)
　- 割り注注記に対応
　- 空行除去 (見出しの後以外)
　- 行頭強制字下げ
　- Web小説取り込み
...
1.1.0b13
　- ルビ内の《》のエスケープ処理修正
　- ID設定用spanをinline-blockのdivに変更 (表題でブロック注記が見出し行になっていた対策)
